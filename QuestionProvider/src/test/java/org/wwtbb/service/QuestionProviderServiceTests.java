...
public class QuestionProviderServiceTests {
    ...
    @InjectMocks
    private QuestionProviderServiceImpl employeeService;

    private Question employee;

    @BeforeEach
    public void setup(){
        //employeeRepository = Mockito.mock(EmployeeRepository.class);
        //employeeService = new EmployeeServiceImpl(employeeRepository);
        employee = Question.builder()
                .id(1L)
                .questionString("Paris").score(2)
                .build();
    }
...
//                .build();
        ...
        // when -  action or the behaviour that we are going test
        List<QuestionProviderDTO> employeeList = employeeService.getAllQuestions();
